...
{
	Super::BeginPlay();
	UE_LOG(LogTemp, Warning, TEXT("Ello"));
...
void AShooterCharacter::AimingbuttonPressed()
{
	...
	if (CombatState != ECombatState::ECS_Reloading && CombatState != ECombatState::ECS_Equipping && CombatState != ECombatState::ESC_Stunned)
	{
		Aim();
	}
}
...
{
	if (CombatState == ECombatState::ESC_Stunned) return;
...
bool AShooterCharacter::TraceUnderCrosshairs(FHitResult& OutHitResult, FVector& OutHitLocation)
{
	...
	// Get screen space of location of crosshairs
...
void AShooterCharacter::EquipWeapon(class AWeapon* WeaponToEquip, bool bSwapping)
{
	if (WeaponToEquip)
	{
		...
		{
			// -1 == no EquippedWeapon yey. No need to reverse the icon animation
...
void AShooterCharacter::Stun()
{
	...
	CombatState = ECombatState::ESC_Stunned;
