...
enum class ECombatState : uint8
{
	...
	ESC_Stunned UMETA(DisplayName = "Stunned"),
...
protected:
	...
	*/
	...
	// Spawns a default weapon and equips
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	// FOV for when zoomed in
	float CameraZoomedFOV;

	// Current FOV this frame
	float CameraCurrentFOV;

	// Interp speed for zoom when aiming
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	float ZoomInterpSpeed;

	// Determines the spread of the crosshairs
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Crosshairs, meta = (AllowPrivateAccess = "true"))
	float CrosshairSpeadMultiplier;
	...
	// Map to keep track ammo of the different ammo types
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Items, meta = (AllowPrivateAccess = "true"))
	...
	// Montage for equipping a weapon
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	...
	// Scene component to attach to the characters hand when reloading
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Combat, meta = (AllowPrivateAccess = "true"))
	...
	// Sound when character hit by melee attack
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
...
public:
	...
	// Returns the index in InterLocations array with the lowest ItemCount
