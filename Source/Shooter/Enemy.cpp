...
void AEnemy::PlayHeadshotSound()
{
	if (HeadshotSound)
	{
		UGameplayStatics::PlaySoundAtLocation(this, HeadshotSound, GetActorLocation());
	}
}
...
void AEnemy::DissolveEnemy_Implementation()
{
...
void AEnemy::BulletHit_Implementation(FHitResult HitResult)
{
	if (ImpactParticals)
	{
		UGameplayStatics::SpawnEmitterAtLocation(GetWorld(), ImpactParticals, HitResult.Location, FRotator(0.f), true);
	}
